...
defmodule ZoomAPI.Model.MeetingCreate do
  @moduledoc """
...
defimpl Poison.Decoder, for: ZoomAPI.Model.MeetingCreate do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:settings, :struct, ZoomAPI.Model.MeetingCreateSettings, options)
  end
end
